...
#data = {}
data = {'2012':data_dir + 'Level6.0000.data.IC86_2.tania_one_percent.pckl',
        '2013':data_dir + 'Level6.0000.data.IC86_3.tania_one_percent.pckl',
        '2014':data_dir + 'Level6.0000.data.IC86_4.tania_one_percent.pckl'}
