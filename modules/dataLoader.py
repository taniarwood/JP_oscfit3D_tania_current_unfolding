...
class dataLoader(object):
    ...
    def loadData(self, year):
        ...
        if year == '2014':
            data2014 = self.addCuts(pickle.load(open(self.user.data['2014'])))
            data = data2014
            self.alldata["2014"] = deepcopy(data2014)
        elif year == '2012':
            ...
            self.alldata["2013"] = deepcopy(data2013)
            for one_obs in self.observables:
                data[one_obs] = np.concatenate((data2014[one_obs], data2012[one_obs], data2013[one_obs]))
